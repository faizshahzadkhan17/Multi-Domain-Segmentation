...
TRAIN_PATH = "../Clean_Dataset/train/mountain_forest"
VAL_PATH = "../Clean_Dataset/val/mountain_forest"

CHECKPOINT_DIR = "../checkpoints/mountain_forest_segformer_b2"
...
train_dataset = MountainForestDataset(
    TRAIN_PATH,
    image_size=IMAGE_SIZE,
    augment=True
)

val_dataset = MountainForestDataset(
    VAL_PATH,
    image_size=IMAGE_SIZE,
    augment=False
)
...
mask_dir = "../Clean_Dataset/train/mountain_forest/Segmentation"
...
plt.title("Mountain Forest Training Curve")

plt.savefig(f"{CHECKPOINT_DIR}/training_curve.png")

print("✅ Mountain/Forest training complete")