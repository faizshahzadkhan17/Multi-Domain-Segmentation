...
TRAIN_PATH = "../Clean_Dataset/train/roads"
VAL_PATH = "../Clean_Dataset/val/roads"

CHECKPOINT_DIR = "../checkpoints/roads_segformer_b2"
...
mask_dir = "../Clean_Dataset/train/roads/Segmentation"
...
plt.title("Roads Training Curve")

plt.savefig(f"{CHECKPOINT_DIR}/training_curve.png")

print("✅ Roads training complete")
